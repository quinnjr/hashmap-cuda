...
// `scopeguard` code is used under the MIT license.
// See: https://raw.githubusercontent.com/bluss/scopeguard/master/LICENSE-MIT
...
impl<T, F> DerefMut for ScopeGuard<T, F> where F: FnMut(&mut T) {
  #[inline]
